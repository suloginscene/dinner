...
import me.scene.dinner.domain.board.application.TopicDto;
import me.scene.dinner.domain.board.application.TopicService;
...
public class TopicController {
    ...
    public String showMagazine(@PathVariable Long topicId, Model model) {
